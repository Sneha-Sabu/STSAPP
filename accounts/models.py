...
class Locations(models.Model):
    ...
    STS_latitude = models.DecimalField(max_digits=5, decimal_places=2, null=True, blank=True)
    STS_longitude = models.DecimalField(max_digits=5, decimal_places=2, null=True, blank=True)
